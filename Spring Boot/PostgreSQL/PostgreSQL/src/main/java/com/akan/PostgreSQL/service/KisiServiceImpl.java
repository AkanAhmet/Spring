package com.akan.PostgreSQL.service;

import com.akan.PostgreSQL.KisiService;
import com.akan.PostgreSQL.dto.KisiDto;
import com.akan.PostgreSQL.entity.Adres;
import com.akan.PostgreSQL.entity.Kisi;
import com.akan.PostgreSQL.repo.AdresRepository;
import com.akan.PostgreSQL.repo.KisiRepository;
...
public class KisiServiceImpl implements KisiService { // Service SADECE DTO lar ile çalışır !
